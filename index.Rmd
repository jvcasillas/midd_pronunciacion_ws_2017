...
### Problema: La fonética no se ha tenido como factor importante en las clases de lengua hasta hace relativamente poco (XXX)
...
- El panorama actual
  ...
  - Formación profesional incluye componentes lingüísticos (¿obligatorios?)

---

# El objetivo del maestro

- Simplificar (no es una clase de fonética)

---

# El objetivo de este taller

- Dar ejemplos de cómo se puede simplificar
...
- cosas acerca de bilingües

---

# SLM, PAM, L2LP

- los modelos actuales propoenen X
- Debe ser posible
- Ciertos segmentos se consideran más o menos difícil según...
	1. la relación fonológica entre la L1 y la L2
	2. la distancia acústica entre los segmentos
- Ej. /i-I/
...
library(RefManageR)
bib <- ReadBib("./assets/bib/pronunciation.bib", check = FALSE)
```
