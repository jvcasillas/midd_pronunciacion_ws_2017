...
writeLines(ui); print(bib[key = "bongaerts1999ultimate"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)

writeLines(ui); print(bib[key = "Bosch2003"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)
...
writeLines(ui); print(bib[key = "escudero2005"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)

writeLines(ui); print(bib[key = "Flege1995"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)
...
writeLines(ui); print(bib[key = "Flege1997"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)
...
writeLines(ui); print(bib[key = "Kuhl:1992wg"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)
...
writeLines(ui); print(bib[key = "Pallier1997a"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)
...
writeLines(ui); print(bib[key = "schwegler2009"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)

writeLines(ui); print(bib[key = "SebastianGalles:1999gn"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)

writeLines(ui); print(bib[key = "Sundara:2006dz"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)

writeLines(ui); print(bib[key = "WERKER1984"], 
  .opts = list(check.entries = FALSE, 
               style = "markdown", 
               bib.style = "authoryear")); writeLines(space)
